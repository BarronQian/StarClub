        ...
        <div className="flex flex-wrap items-center gap-12 lg:gap-16">
          {PARTNERS.map((partner) => (
            <a
              ...
              title={partner.name}
              className="group flex min-h-45 items-center justify-center px-10"
            >
              <img
                src={partner.logo}
                alt={partner.name}
                className="
                  h-auto max-h-36 w-auto max-w-90 object-contain
                  transition-all duration-300 ease-out
                  group-hover:-translate-y-1
                  group-hover:scale-105
                  group-hover:drop-shadow-[0_10px_18px_rgba(0,0,0,0.10)]
                  dark:group-hover:drop-shadow-[0_10px_20px_rgba(0,0,0,0.18)]
                "
              />
            </a>
          ))}

    ...
    <div className="inline-flex flex-wrap items-center gap-x-4 gap-y-2">
      ...
      {rsiVerified && (
        <button
          ...
          onClick={onRsiClick}
          disabled={!onRsiClick}
          className={`group/verification relative flex shrink-0 items-center gap-1.5 ${
            onRsiClick
              ? 'cursor-pointer'
              : 'cursor-default'
          }`}
        >
          <BadgeCheck
            className={`${iconSize} fill-[#1689e8] text-white transition-transform duration-150 group-hover/verification:scale-110`}
            strokeWidth={2.5}
          />
      ...
      {/* StarClub Discord */}
      {discordVerified && (
        <div className="group/verification relative flex shrink-0 items-center gap-1.5">
          <div
            className={`${iconSize} flex items-center justify-center rounded-full bg-[#5865F2] transition-transform duration-150 group-hover/verification:scale-110`}
          >
            <Image
      ...
      {orgVerified && (
        <div className="group/verification relative flex shrink-0 items-center gap-1.5">
          <Image
            ...
            width={imageSize}
            height={imageSize}
            className={`${iconSize} object-contain transition-transform duration-150 group-hover/verification:scale-110`}
          />

...
export const GALLERY: GalleryShot[] = [
  ...
  {
    src: '/images/gallery-ship-racing-match.jpg',
    alt: '多艘飞船在赛道中激烈竞速',
    caption: '逐星之翼杯赛道',
    author: '@Godoil',
    category: 'racing',
  ...
  {
    src: '/images/gallery-dogfight-class.png',
    alt: '飞船狗斗竞技场中的激烈交火',
    caption: '狗斗竞技场',
    author: '@Kumamoto_Bear',
    category: 'combat',
    width: 2576,
    height: 1449,
    aspectRatio: 2576 / 1449,
    publishedAt: '2026-05-02',
    likes: 89,
  },
  {
    src: '/images/gallery-siege-of-orison.jpg',
    alt: '玩家小队在 Orison 空间站发起地面攻坚行动',
    caption: 'Orison 攻坚战',
    author: '@Lion_Shipcrasher',
    category: 'combat',
    width: 1680,
    height: 945,

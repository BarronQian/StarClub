  ...
  return (
    <>
                            ...
                            <div className="flex shrink-0 items-center gap-2">
                              ...
                              {message.canDelete && (
                                <button
                                  ...
                                  className="rounded-md p-1 text-muted-foreground transition-colors hover:bg-neutral-100 hover:text-red-600"
                                >
      ...
      {cooldownUntil && (
        ...
        >
          <div
            className="relative w-full max-w-sm rounded-3xl border border-black/10 bg-white p-6 shadow-[0_24px_80px_rgba(0,0,0,0.20)]"
            onClick={(event) =>
          ...
          >
            <button
              ...
              className="absolute right-4 top-4 flex size-8 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-black/5 hover:text-foreground"
              aria-label="关闭"
            >
              <X className="size-4" />
            </button>
            ...
            <div className="mt-5 rounded-2xl border border-border bg-[#f8f7f4] px-4 py-4">
              <p className="text-xs text-muted-foreground">
                下次可留言时间
              </p>
